...
from app.db.session import get_async_session, sessionmanager
...
def app():
    with ExitStack():
        yield init_app(initiliaze_db=False)
...
test_db = factories.postgresql_proc(port=None, dbname='test_financedb')
